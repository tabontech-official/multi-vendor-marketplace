    ...
    try {
      ...
      const shopifyPayload = {
        product: {
          ...
          images: [{ src: `http://localhost:3000/${image.path}` }], // Adjust URL based on your server setup
        },
      };
      ...
      // Update MongoDB document with Shopify ID
      await listingModel.findByIdAndUpdate(savedListing._id, { shopifyId });
