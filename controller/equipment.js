    ...
    try {
      ...
      const shopifyPayload = {
        product: {
          ...
          images: [{ src: `http://localhost:4000/${image.filename}` }], // Adjust URL based on your server setup
        },
      };
      ...
      const shopifyEquipmentId = shopifyResponse.product.id; // Extract Shopify equipment ID
      ...
      const newListing = new listingModel({
        ...
        shopifyEquipmentId, // Store Shopify equipment ID
      });
