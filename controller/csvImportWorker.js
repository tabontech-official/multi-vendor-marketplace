...
// export const processSingleProduct = async ({
//   handle,
//   productRows,
//   userId,
//   batch,
...
export async function limitedShopifyRequest(
  url,
  method,
  body,
  shopifyApiKey,
...
export async function preloadCategoryCache() {
  const categories = await categoryModel.find({}).lean();
...
export function generateHandle(value) {
  return value
    ?.toString()
    .trim()
    .toLowerCase()
